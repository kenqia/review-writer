    ...
    _run_node(
        "\n".join(
            [
                ...
                "  sections:[{section_id:'s1', heading:'结果', body:'原表述', status:'needs_human_edit', version_token:'opaque-v1', risk_classes:['quantitative'], claim_bindings:[{paper_evidence_ids:['e1'], synthesis_ids:['c1']}], unknown_path:'/private'}],",
                ...
                "  source_figures:[{figure_id:'f1', title:'原论文图 2', caption:'实验结果', image_url:'/safe/figure', pdf_page_url:'/safe/page'}]",
                "});",
