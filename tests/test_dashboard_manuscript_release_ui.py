    ...
    _run_node(
        "\n".join(
            [
                ...
                "const projectOptionIds=new Map([['project-option-1','regression-v1'],['project-option-2','fresh-v2']]);const projectOptionKeys=new Map([['regression-v1','project-option-1'],['fresh-v2','project-option-2']]);",
    ...
    _run_node(
        "\n".join(
            [
                ...
                "const projectOptionIds=new Map([['project-option-1','fresh-v2']]);const projectOptionKeys=new Map([['fresh-v2','project-option-1']]);",
                "const confirmDiscardDraftChanges=()=>true,confirmDiscardRiskDecisions=()=>true,confirmDiscardParseQualityDecisions=()=>true;",
    ...
    _run_node(
        "\n".join(
            [
                ...
                "const projectOptionIds=new Map([['project-option-1','project-a'],['project-option-2','project-b']]);const projectOptionKeys=new Map([['project-a','project-option-1'],['project-b','project-option-2']]);",
                "const confirmDiscardDraftChanges=()=>true,confirmDiscardRiskDecisions=()=>true,confirmDiscardParseQualityDecisions=()=>true;",
                "const setProjectLoadBusy=value=>{projectLoadBusy=value;};",
                "let selectionWorkspaceCount=0;const setProjectSelectionWorkspace=()=>{selectionWorkspaceCount+=1;};",
