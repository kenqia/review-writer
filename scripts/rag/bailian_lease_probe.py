...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- exception_module: `{safe_error.get('exception_module')}`",
        ...
        f"- context_class: `{safe_error.get('context_class')}`",
        f"- context_message_redacted: {safe_error.get('context_message_redacted')}",
        f"- args_count: `{safe_error.get('args_count')}`",
